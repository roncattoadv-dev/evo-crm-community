module Whatsapp::EvolutionHandlers::Helpers
  ...
  def raw_message_id
    # keyId é o ID real do WhatsApp e corresponde ao source_id no DB.
    # messageId é o ID interno da Evolution API e NÃO está armazenado.
    # Para messages.update: keyId vem primeiro para garantir o match correto.
