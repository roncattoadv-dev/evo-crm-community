class AgentBots::N8nRequestService
  ...
  def build_n8n_payload
...

    {
      ...
      ctwaClid: extract_ctwa_clid,
      source_id: extract_ad_source_id
    }
  end
  ...
  def extract_ctwa_clid
    @payload.dig(:content_attributes, :ctwa_clid) ||
      @payload.dig(:content_attributes, 'ctwa_clid')
  end

  def extract_ad_source_id
    @payload.dig(:content_attributes, :ad_source_id) ||
      @payload.dig(:content_attributes, 'ad_source_id')
  end
